# Credits of this file: https://github.com/facebookresearch/dinov2
...
from torch.distributed import send as send
from torch.distributed import recv as recv
...
def get_backend() -> str:
    """
    Returns:
        The backend used for distributed training
    """
    return _BACKEND
